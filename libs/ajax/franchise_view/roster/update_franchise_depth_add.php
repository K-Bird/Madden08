...
$addNewPlayer = db_query("Insert into `franchise_year_roster` (Name, Position, Overall, Age, Acquired, Rookie, OSU, Team, Year) Values ('{$addName}','{$position}','{$addOverall}','{$addAge}', '{$addOnTeam}', '{$addVetRookie}', '{$addOSU}', '{$franchise}','{$franchiseYear}')");
