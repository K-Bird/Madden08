...
$addNewPlayer = db_query("Insert into `franchise_year_awards` (Player, Position, Award, Historical_ID, Year, Team) Values ('{$playerName}','{$position}','{$award}','{$historicalID}','{$franYear}','{$franchise}')");
