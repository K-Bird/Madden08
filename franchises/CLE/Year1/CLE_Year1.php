...
<html>
    ...
    <body style="background-color: #351D05; color: #DD6633;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12" style="text-align: center">
                    <header><h1>CLE - Year 1</h1></header>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <?php include ('CLE_Year1_PreSeason_Table.php'); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <?php include ('CLE_Year1_Roster_Table.php'); ?>
                </div>
            </div>
            <?php
            ...
            if ($_SESSION['Admin'] == true) {
                echo '<div class="row">';
                include ('_Forms/CLE_Year1_RosterForms.php');
                echo '</div>';
            }
            ?>
            <div class="row">
                <div class="col-lg-12">
                    <br><br>
                    <?php include ('CLE_Year1_Reg_Table.php'); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <?php include ('CLE_Year1_Team_Table.php'); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <br><br>
                    <?php include ('CLE_Year1_Stats_Table.php'); ?>
                </div>
            </div>
            <?php
            ...
            if ($_SESSION['Admin'] == true) {
                echo '<div class="row">';
                include ('_Forms/CLE_Year1_StatsForms.php');
                echo '</div>';
            }
            ?>
            <div class="row">
                <div class="col-lg-12">
                    <br><br>
                    <?php include ('CLE_Year1_Coach_Table.php'); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <br><br>
                    <?php include ('CLE_Year1_Offseason_Table.php'); ?>
                </div>
            </div>
            <?php
            /* | IF USER IS LOGGED IN - Display Stat Forms | */
            if ($_SESSION['Admin'] == true) {
                echo '<div class="row">';
                include ('_Forms/CLE_Year1_OffseasonForms.php');
                echo '</div>';
            }
            ?>
            <div class="row" style="text-align: center">
                <div class="col-lg-12">
                    <ul class="pagination">
                        ...
                        for ($i = 1; $i <= $YearNo; $i++) {
                            echo '<li><a href=../Year' . $i . '/CLE_Year' . $i . '.php>Year ' . $i . '</a></li>';
                        }
                        ?>
                    </ul>
                    <br>
