...
if (!isset($_SESSION['Admin'])) {
    ...
    echo '<td colspan="2">Assets: </td><td id="', $Arow['Row'], '/buf/1/Asset" onclick="updateInfo(this)">', $Arow['Value'], '</td><td>Training Staff: </td><td id="', $Trow['Row'], '/buf/1/TrainStaff" onclick="updateInfo(this)">', $Trow['Value'], '</td>';
    ...
    while ($row = mysql_fetch_array($result)) {
        echo '<tr>';
        echo '<td colspan="5" id="', $row['Row'], '/buf/1/Player" onclick="updateOff(this)">', $row['Player'], '</td>
    ...
    echo '<td colspan="2" id="', $row['Row'], '/buf/1/Player" onclick="updateOff(this)">Player</td>', '<td colspan="3">', 'Award', '</td>';
    echo '</tr>';


    while ($row = mysql_fetch_array($result)) {
        echo '<tr>';
        echo '<td colspan="2" id="', $row['Row'], '/buf/1/Player" onclick="updateOff(this)">', $row['Player'], '</td>', '<td colspan="3" id="', $row['Row'], '/buf/1/Award" onclick="updateOff(this)">', $row['Award'], '</td>
					<td><form action="_Update/Remove_Offseason_Row.php" method = "post">
					<input class="btn btn-danger" type="submit" name="Remove" value="Remove Row" />
					<input type="hidden" name="fran" value="buf"></input>
					<input type="hidden" name="year" value="1"></input>
    ...
    echo '<td colspan="2" id="', $row['Row'], '/buf/1/Player" onclick="updateOff(this)">Player</td>', '<td>', 'Position', '</td>', '<td>', 'Overall', '</td>', '<td>', 'Age', '</td>';
    echo '</tr>';


    while ($row = mysql_fetch_array($result)) {
        echo '<tr>';
        echo '<td colspan="2" id="', $row['Row'], '/buf/1/Player" onclick="updateOff(this)">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/Position" onclick="updateOff(this)">', $row['Position'], '</td>', '<td id="', $row['Row'], '/buf/1/Overall" onclick="updateOff(this)">', $row['Overall'], '</td>', '<td id="', $row['Row'], '/buf/1/Age" onclick="updateOff(this)">', $row['Age'], '</td>
					<td><form action="_Update/Remove_Offseason_Row.php" method = "post">
					<input class="btn btn-danger" type="submit" name="Remove" value="Remove Row" />
					<input type="hidden" name="fran" value="buf"></input>
					<input type="hidden" name="year" value="1"></input>
    ...
    while ($row = mysql_fetch_array($result)) {
        echo '<tr>';
        echo '<td id="', $row['Row'], '/buf/1/Pick" onclick="updateOff(this)">', $row['Pick'], '</td>', '<td id="', $row['Row'], '/buf/1/Player" onclick="updateOff(this)">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/Position" onclick="updateOff(this)">', $row['Position'], '</td>', '<td id="', $row['Row'], '/buf/1/Overall" onclick="updateOff(this)">', $row['Overall'], '</td>', '<td id="', $row['Row'], '/buf/1/Age" onclick="updateOff(this)">', $row['Age'], '</td>
					<td><form action="_Update/Remove_Offseason_Row.php" method = "post">
					<input class="btn btn-danger" type="submit" name="Remove" value="Remove Row" />
					<input type="hidden" name="fran" value="buf"></input>
					<input type="hidden" name="year" value="1"></input>
    ...
    if ($RelRow['Value'] == '') {
        ...
        echo '<td colspan="5" id="', $row['Row'], '/buf/1/Field" onclick="updateInfo(this)">', $row['Value'], '</td>';
    }
}
...
if ($_SESSION['Admin'] == false) {
    ...
    echo '<td>Assets: </td><td id="', $Arow['Row'], '/buf/1/Field">', $Arow['Value'], '</td><td></td><td>Training Staff: </td><td id="', $Trow['Row'], '/buf/1/Field">', $Trow['Value'], '</td>';
    ...
    while ($row = mysql_fetch_array($result)) {
        echo '<tr>';
        echo '<td colspan="2">', $row['Player'], '</td>', '<td colspan="3" id="', $row['Row'], '/buf/1/Award" onclick="">', $row['Award'], '</td>';
        echo '</tr>';
    }
    ...
    while ($row = mysql_fetch_array($result)) {
        echo '<tr>';
        echo '<td colspan="2">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/Position" onclick="">', $row['Position'], '</td>', '<td id="', $row['Row'], '/buf/1/Overall" onclick="">', $row['Overall'], '</td>', '<td id="', $row['Row'], '/buf/1/Age" onclick="">', $row['Age'], '</td>';
        echo '</tr>';
    }
    ...
    while ($row = mysql_fetch_array($result)) {
        echo '<tr>';
        echo '<td id="', $row['Row'], '/buf/1/Pick" onclick="">', $row['Pick'], '</td>', '<td id="', $row['Row'], '/buf/1/Player" onclick="">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/Position" onclick="">', $row['Position'], '</td>', '<td id="', $row['Row'], '/buf/1/Overall" onclick="">', $row['Overall'], '</td>', '<td id="', $row['Row'], '/buf/1/Age" onclick="">', $row['Age'], '</td>';
        echo '</tr>';
    }
    ...
    if ($RelRow['Value'] == '') {
        ...
        $result = mysql_query("SELECT * FROM `gm_madden08-buf_1_info` Where Field='Rel'");
        $row = mysql_fetch_array($result);
        echo '<td colspan="5" id="', $row['Row'], '/buf/1/Relocation">', $row['Value'], '</td>';
    }
}
