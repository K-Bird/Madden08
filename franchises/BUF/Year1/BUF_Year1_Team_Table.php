...
echo "<br />";
echo '<table class="table table-hover" id="buf_1_Reg_Team" style="text-align: center; font-size: small">';
echo '<tr>';
...
if (!isset($_SESSION['Admin'])) {
    ...
    while ($row = mysql_fetch_array($result)) {
        echo '<tr>';
        echo '<td>', $row['Stat'], '</td>', '<td id="', $row['Row'], '/buf/1" onclick="updateTeamStat(this)">', $row['Value'], '</td>';
        echo '</tr>';
    }
}
