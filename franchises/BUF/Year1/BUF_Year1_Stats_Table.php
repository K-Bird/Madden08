...
if (!isset($_SESSION['Admin'])) {
    ...
    while ($row = mysql_fetch_array($result)) {
        if ($row['Player'] == '') {
            echo '<tr><td id="', $row['Row'], '/buf/1/Player" onclick="updateStat(this)">', $row['Player'], '</td>',
	...
	<input type="hidden" name="fran" value="buf"></input>
	<input type="hidden" name="year" value="1"></input>
	<input type="hidden" name="row" value="', $row['Row'], '"></input>
	</form></td></tr>';
        } else { {
                echo '<tr>';
                echo '<td id="', $row['Row'], '/buf/1/Player" onclick="updateStat(this)">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/Rating" onclick="updateStat(this)">', $row['Rating'], '</td>', '<td id="', $row['Row'], '/buf/1/Yds" onclick="updateStat(this)">', $row['Yds'], '</td>', '<td id="', $row['Row'], '/buf/1/TDs" onclick="updateStat(this)">', $row['TDs'], '</td>', '<td id="', $row['Row'], '/buf/1/INTs" onclick="updateStat(this)">', $row['INTs'], '</td>', '<td id="', $row['Row'], '/buf/1/Percent" onclick="updateStat(this)">', $row['Percent'], '</td>', '<td id="', $row['Row'], '/buf/1/Sacks" onclick="updateStat(this)">', $row['Sacks'], '</td>';
                echo '</tr>';
            }
        }
    }
	...
	<input type="hidden" name="row" value="', $row['Row'], '"></input>
            ...
            echo '<tr>';
            echo '<td id="', $row['Row'], '/buf/1/Player" onclick="updateStat(this)">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/Yds" onclick="updateStat(this)">', $row['Yds'], '</td>', '<td id="', $row['Row'], '/buf/1/TDs" onclick="updateStat(this)">', $row['TDs'], '</td>', '<td id="', $row['Row'], '/buf/1/AVG" onclick="updateStat(this)">', $row['AVG'], '</td>', '<td id="', $row['Row'], '/buf/1/Fumbles" onclick="updateStat(this)">', $row['Fumbles'], '</td>', '<td id="', $row['Row'], '/buf/1/BrokenTackles" onclick="updateStat(this)">', $row['BrokenTackles'], '</td>', '<td id="', $row['Row'], '/buf/1/Longest" onclick="updateStat(this)">', $row['Longest'], '</td>';
            echo '</tr>';
        }
    }
	...
	<input type="hidden" name="row" value="', $row['Row'], '"></input>
            ...
            echo '<tr>';
            echo '<td id="', $row['Row'], '/buf/1/Player" onclick="updateStat(this)">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/Rec" onclick="updateStat(this)">', $row['Rec'], '</td>', '<td id="', $row['Row'], '/buf/1/Yds" onclick="updateStat(this)">', $row['Yds'], '</td>', '<td id="', $row['Row'], '/buf/1/TDs" onclick="updateStat(this)">', $row['TDs'], '</td>', '<td id="', $row['Row'], '/buf/1/AVG" onclick="updateStat(this)">', $row['AVG'], '</td>', '<td id="', $row['Row'], '/buf/1/Longest" onclick="updateStat(this)">', $row['Longest'], '</td>', '<td id="', $row['Row'], '/buf/1/Dropped" onclick="updateStat(this)">', $row['Dropped'], '</td>';
            echo '</tr>';
        }
    }
	...
	<input type="hidden" name="row" value="', $row['Row'], '"></input>
            ...
            echo '<tr>';
            echo '<td id="', $row['Row'], '/buf/1/Player" onclick="updateStat(this)">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/Tackles" onclick="updateStat(this)">', $row['Tackles'], '</td>', '<td id="', $row['Row'], '/buf/1/ForLoss" onclick="updateStat(this)">', $row['ForLoss'], '</td>', '<td id="', $row['Row'], '/buf/1/Sacks" onclick="updateStat(this)">', $row['Sacks'], '</td>', '<td id="', $row['Row'], '/buf/1/INTs" onclick="updateStat(this)">', $row['INTs'], '</td>', '<td id="', $row['Row'], '/buf/1/TDs" onclick="updateStat(this)">', $row['TDs'], '</td>', '<td id="', $row['Row'], '/buf/1/Safety" onclick="updateStat(this)">', $row['Safety'], '</td>';
            echo '</tr>';
        }
    }
	...
	<input type="hidden" name="row" value="', $row['Row'], '"></input>
            ...
            echo '<tr>';
            echo '<td colspan="5" id="', $row['Row'], '/buf/1/Player" onclick="updateStat(this)">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/Pancakes" onclick="updateStat(this)">', $row['Pancakes'], '</td>', '<td id="', $row['Row'], '/buf/1/Sacks" onclick="updateStat(this)">', $row['Sacks'], '</td>';
            echo '</tr>';
        }
    }
	...
	<input type="hidden" name="row" value="', $row['Row'], '"></input>
            ...
            echo '<tr>';
            echo '<td colspan="3" id="', $row['Row'], '/buf/1/Player" onclick="updateStat(this)">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/Made" onclick="updateStat(this)">', $row['Made'], '</td>', '<td id="', $row['Row'], '/buf/1/Attempted" onclick="updateStat(this)">', $row['Attempted'], '</td>', '<td id="', $row['Row'], '/buf/1/KickPercent" onclick="updateStat(this)">', $row['KickPercent'], '</td>', '<td id="', $row['Row'], '/buf/1/Longest" onclick="updateStat(this)">', $row['Longest'], '</td>';
            echo '</tr>';
        }
    }
    ...
    echo '<td colspan="5" id="', $row['Row'], '/buf/1/Player" onclick="updateStat(this)">Player</td>', '<td>', 'Punt Average', '</td>', '<td>', '# Inside the 20', '</td>';
    echo '</tr>';
	...
	<input type="hidden" name="row" value="', $row['Row'], '"></input>
            ...
            echo '<tr>';
            echo '<td colspan="5" id="', $row['Row'], '/buf/1/Player" onclick="updateStat(this)">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/AVG" onclick="updateStat(this)">', $row['AVG'], '</td>', '<td id="', $row['Row'], '/buf/1/KPS" onclick="updateStat(this)">', $row['KPS'], '</td>';
            echo '</tr>';
        }
    }
    ...
    echo '<td colspan="4" id="', $row['Row'], '/buf/1/Player" onclick="updateStat(this)">Player</td>', '<td>', 'Return Average', '</td>', '<td>', 'Return TDs', '</td>', '<td>', 'Longest Return', '</td>';
    echo '</tr>';
	...
	<input type="hidden" name="row" value="', $row['Row'], '"></input>
            ...
            echo '<tr>';
            echo '<td colspan="4" id="', $row['Row'], '/buf/1/Player" onclick="updateStat(this)">', $row['Player'], '</td>', '<td id="', $row['Row'], '/buf/1/AVG" onclick="updateStat(this)">', $row['AVG'], '</td>', '<td id="', $row['Row'], '/buf/1/TDs" onclick="updateStat(this)">', $row['TDs'], '</td>', '<td id="', $row['Row'], '/buf/1/Longest" onclick="updateStat(this)">', $row['Longest'], '</td>';
            echo '</tr>';
        }
    }
}
