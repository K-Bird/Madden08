<table class="table table-hover" id="offprefaStatsTable" style="text-align: center; font-size: small">
                    ...
                    while ($offprefaRow = $offprefaResult->fetch_assoc()) {
                        ...
                        '<td><a class="btn btn-danger franViewEdit" style="display: none" id="',$offprefaRow['Row'],'" onclick="removeMovesRow(this)">Remove Row</a></td>',
                        '</tr>';
                    }
                    ?>
                    <tr>
                        <td colspan="7"><a class="btn btn-success franViewEdit offMove" data-movetype="prefa" data-toggle="modal" data-target="#addMoves" style="display:none">Add Pre-Draft Free Agent</a></td>
                    </tr>
                </table>