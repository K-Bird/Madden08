...
/* * ** Coaching Table *** */
echo '<table class="CSSTableGenerator" id="buf_1_Coaches">';
echo '<tr>';
echo '<td colspan="4">Coaches</td>';
echo '</tr>';
echo '<tr>';
echo '<td  style="background-color:crimson">Head Coach</td>', '<td  style="background-color:crimson">', 'Offensive Coordinator', '</td>', '<td  style="background-color:crimson">', 'Defensive Coordinator', '</td>', '<td  style="background-color:crimson">', 'Special Teams Coordinator', '</td>';
echo '</tr>';
echo '<tr>';
...
/* * ** Depth Chart Table *** */
echo '<table class="CSSTableGenerator" id="buf_1_DepthChart">
    <tr>
        <td colspan="7">Depth Chart</td>
    </tr>
    <tr>
        <td colspan="4" style="background-color:crimson">Offence</td>
        <td colspan="3" style="background-color:crimson">Defense</td>
    </tr>
    <tr>
        <td style="background-color:crimson">3rd String</td>
        <td style="background-color:crimson">2nd String</td>
        <td style="background-color:crimson">Starter</td>
        <td style="background-color:crimson" colspan="2" >|-------- Position ----|</td>
        <td style="background-color:crimson">Starter</td>
        <td style="background-color:crimson">2nd String</td>
    </tr>
    <tr>
...
if ($numRows > 0) {
    ...
    echo '<td>', $WR1row['Name'], ' ', $WR1row['Weapon'], '<br> Overall: ', $WR1row['Overall'], ' Age: ', $WR1row['Age'], '<br> [ ', $WR1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No WR1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $CB1row['Name'], ' ', $CB1row['Weapon'], '<br> Overall: ', $CB1row['Overall'], ' Age: ', $CB1row['Age'], '<br> [ ', $CB1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No CB1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $WR4row['Name'], ' ', $WR4row['Weapon'], '<br> Overall: ', $WR4row['Overall'], ' Age: ', $WR4row['Age'], '<br> [ ', $WR4row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No WR4</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $CB4row['Name'], ' ', $CB4row['Weapon'], '<br> Overall: ', $CB4row['Overall'], ' Age: ', $CB4row['Age'], '<br> [ ', $CB4row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No CB4</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $LT2row['Name'], ' ', $LT2row['Weapon'], '<br> Overall: ', $LT2row['Overall'], ' Age: ', $LT2row['Age'], '<br> [ ', $LT2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No LT2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $LT1row['Name'], ' ', $LT1row['Weapon'], '<br> Overall: ', $LT1row['Overall'], ' Age: ', $LT1row['Age'], '<br> [ ', $LT1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No LT1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $LOLB1row['Name'], ' ', $LOLB1row['Weapon'], '<br> Overall: ', $LOLB1row['Overall'], ' Age: ', $LOLB1row['Age'], '<br> [ ', $LOLB1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No LOLB1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $LOLB2row['Name'], ' ', $LOLB2row['Weapon'], '<br> Overall: ', $LOLB2row['Overall'], ' Age: ', $LOLB2row['Age'], '<br> [ ', $LOLB2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No LOLB2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $LG2row['Name'], ' ', $LG2row['Weapon'], '<br> Overall: ', $LG2row['Overall'], ' Age: ', $LG2row['Age'], '<br> [ ', $LG2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No LG2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $LG1row['Name'], ' ', $LG1row['Weapon'], '<br> Overall: ', $LG1row['Overall'], ' Age: ', $LG1row['Age'], '<br> [ ', $LG1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No LG1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $MLB1row['Name'], ' ', $MLB1row['Weapon'], '<br> Overall: ', $MLB1row['Overall'], ' Age: ', $MLB1row['Age'], '<br> [ ', $MLB1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No MLB1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $C2row['Name'], ' ', $C2row['Weapon'], '<br> Overall: ', $C2row['Overall'], ' Age: ', $C2row['Age'], '<br> [ ', $C2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No C2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $C1row['Name'], ' ', $C1row['Weapon'], '<br> Overall: ', $C1row['Overall'], ' Age: ', $C1row['Age'], '<br> [ ', $C1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No C1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $LE1row['Name'], ' ', $LE1row['Weapon'], '<br> Overall: ', $LE1row['Overall'], ' Age: ', $LE1row['Age'], '<br> [ ', $LE1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No LE1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $LE2row['Name'], ' ', $LE2row['Weapon'], '<br> Overall: ', $LE2row['Overall'], ' Age: ', $LE2row['Age'], '<br> [ ', $LE2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No LE2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $RG2row['Name'], ' ', $RG2row['Weapon'], '<br> Overall: ', $RG2row['Overall'], ' Age: ', $RG2row['Age'], '<br> [ ', $RG2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No RG2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $RG1row['Name'], ' ', $RG1row['Weapon'], '<br> Overall: ', $RG1row['Overall'], ' Age: ', $RG1row['Age'], '<br> [ ', $RG1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No RG1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $DT1row['Name'], ' ', $DT1row['Weapon'], '<br> Overall: ', $DT1row['Overall'], ' Age: ', $DT1row['Age'], '<br> [ ', $DT1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No DT1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $DT2row['Name'], ' ', $DT2row['Weapon'], '<br> Overall: ', $DT2row['Overall'], ' Age: ', $DT2row['Age'], '<br> [ ', $DT2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No DT2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $RT2row['Name'], ' ', $RT2row['Weapon'], '<br> Overall: ', $RT2row['Overall'], ' Age: ', $RT2row['Age'], '<br> [ ', $RT2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No RT2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $RT1row['Name'], ' ', $RT1row['Weapon'], '<br> Overall: ', $RT1row['Overall'], ' Age: ', $RT1row['Age'], '<br> [ ', $RT1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No RT1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $RE1row['Name'], ' ', $RE1row['Weapon'], '<br> Overall: ', $RE1row['Overall'], ' Age: ', $RE1row['Age'], '<br> [ ', $RE1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No RE1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $RE2row['Name'], ' ', $RE2row['Weapon'], '<br> Overall: ', $RE2row['Overall'], ' Age: ', $RE2row['Age'], '<br> [ ', $RE2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No RE2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $WR3row['Name'], ' ', $WR3row['Weapon'], '<br> Overall: ', $WR3row['Overall'], ' Age: ', $WR3row['Age'], '<br> [ ', $WR3row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No WR3</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $MLB2row['Name'], ' ', $MLB2row['Weapon'], '<br> Overall: ', $MLB2row['Overall'], ' Age: ', $MLB2row['Age'], '<br> [ ', $MLB2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No MLB2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $WR2row['Name'], ' ', $WR2row['Weapon'], '<br> Overall: ', $WR2row['Overall'], ' Age: ', $WR2row['Age'], '<br> [ ', $WR2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No WR2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $ROLB1row['Name'], ' ', $ROLB1row['Weapon'], '<br> Overall: ', $ROLB1row['Overall'], ' Age: ', $ROLB1row['Age'], '<br> [ ', $ROLB1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No ROLB1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $ROLB2row['Name'], ' ', $ROLB2row['Weapon'], '<br> Overall: ', $ROLB2row['Overall'], ' Age: ', $ROLB2row['Age'], '<br> [ ', $ROLB2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No ROLB2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $TE2row['Name'], ' ', $TE2row['Weapon'], '<br> Overall: ', $TE2row['Overall'], ' Age: ', $TE2row['Age'], '<br> [ ', $TE2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No TE2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $TE1row['Name'], ' ', $TE1row['Weapon'], '<br> Overall: ', $TE1row['Overall'], ' Age: ', $TE1row['Age'], '<br> [ ', $TE1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No TE1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $CB3row['Name'], ' ', $CB3row['Weapon'], '<br> Overall: ', $CB3row['Overall'], ' Age: ', $CB3row['Age'], '<br> [ ', $CB3row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No CB3</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $QB2row['Name'], ' ', $QB2row['Weapon'], '<br> Overall: ', $QB2row['Overall'], ' Age: ', $QB2row['Age'], '<br> [ ', $QB2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No QB2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $QB1row['Name'], ' ', $QB1row['Weapon'], '<br> Overall: ', $QB1row['Overall'], ' Age: ', $QB1row['Age'], '<br> [ ', $QB1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No QB1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $CB2row['Name'], ' ', $CB2row['Weapon'], '<br> Overall: ', $CB2row['Overall'], ' Age: ', $CB2row['Age'], '<br> [ ', $CB2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No CB2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $FB1row['Name'], ' ', $FB1row['Weapon'], '<br> Overall: ', $FB1row['Overall'], ' Age: ', $FB1row['Age'], '<br> [ ', $FB1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No FB1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $FS1row['Name'], ' ', $FS1row['Weapon'], '<br> Overall: ', $FS1row['Overall'], ' Age: ', $FS1row['Age'], '<br> [ ', $FS1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No FS1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $FS2row['Name'], ' ', $FS2row['Weapon'], '<br> Overall: ', $FS2row['Overall'], ' Age: ', $FS2row['Age'], '<br> [ ', $FS2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No FS2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $HB3row['Name'], ' ', $HB3row['Weapon'], '<br> Overall: ', $HB3row['Overall'], ' Age: ', $HB3row['Age'], '<br> [ ', $HB3row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No HB3</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $HB2row['Name'], ' ', $HB2row['Weapon'], '<br> Overall: ', $HB2row['Overall'], ' Age: ', $HB2row['Age'], '<br> [ ', $HB2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No HB2</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $HB1row['Name'], ' ', $HB1row['Weapon'], '<br> Overall: ', $HB1row['Overall'], ' Age: ', $HB1row['Age'], '<br> [ ', $HB1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No HB1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $SS1row['Name'], ' ', $SS1row['Weapon'], '<br> Overall: ', $SS1row['Overall'], ' Age: ', $SS1row['Age'], '<br> [ ', $SS1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No SS1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $SS2row['Name'], ' ', $SS2row['Weapon'], '<br> Overall: ', $SS2row['Overall'], ' Age: ', $SS2row['Age'], '<br> [ ', $SS2row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No SS2</td>';
}
echo '</tr></table><br>';
...
/* * ** Special Teams Table *** */
echo '<a href="#depth"></a>';
echo '<table class="CSSTableGenerator" id="buf_1_ST">';
echo '<tr>';
echo '<td colspan="4">Special Teams</td>';
echo '</tr>';
echo '<tr>';
echo '<td  style="background-color:crimson">Kicker</td>', '<td  style="background-color:crimson">', 'Punter', '</td>', '<td  style="background-color:crimson">', 'Kick Returner', '</td>', '<td  style="background-color:crimson">', 'Punt Returner', '</td>';
echo '</tr>';
echo '<tr>';
...
if ($numRows > 0) {
    ...
    echo '<td>', $K1row['Name'], ' ', $K1row['Weapon'], '<br> Overall: ', $K1row['Overall'], ' Age: ', $K1row['Age'], '<br> [ ', $K1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No K1</td>';
}
...
if ($numRows > 0) {
    ...
    echo '<td>', $P1row['Name'], ' ', $P1row['Weapon'], '<br> Overall: ', $P1row['Overall'], ' Age: ', $P1row['Age'], '<br> [ ', $P1row['Acquired'], ' ]', '</td>';
} else {
    echo '<td>No P1</td>';
}
...
/* | IF USER IS LOGGED IN - Display Add, Update, Remove Forms | */
if ($_SESSION['Admin'] == true) {
    include ('_Forms/RosterForms.php');
}
mysql_close($con);
?>
