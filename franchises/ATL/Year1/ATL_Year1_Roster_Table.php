...
/* * ** Coaching Table *** */
echo '<table class="table table-hover" id="ATL_1_Coaches" style="text-align: center; font-size: small">';
echo '<tr>';
...
/* HC Cell Block */
$HCresult = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='HC'");
...
/* OC Cell Block */
$OCresult = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='OC'");
...
/* DC Cell Block */
$DCresult = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='DC'");
...
/* ST Cell Block */
$STresult = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='ST'");
...
/* * ** Depth Chart Table *** */
echo '<table class="table table-hover" id="atl_1_DepthChart" style="text-align: center; font-size: small">
    <tr>
...
/* WR1 Cell Block */
$WR1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='WR1'");
...
/* CB1 Cell Block */
$CB1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='CB1'");
...
/* WR4 Cell Block */
$WR4result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='WR4'");
...
/* CB4 Cell Block */
$CB4result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='CB4'");
...
/* LT2 Cell Block */
$LT2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='LT2'");
...
/* LT1 Cell Block */
$LT1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='LT1'");
...
/* LOLB1 Cell Block */
$LOLB1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='LOLB1'");
...
/* LOLB2 Cell Block */
$LOLB2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='LOLB2'");
...
/* LG2 Cell Block */
$LG2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='LG2'");
...
/* LG1 Cell Block */
$LG1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='LG1'");
...
/* MLB1 Cell Block */
$MLB1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='MLB1'");
...
/* C2 Cell Block */
$C2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='C2'");
...
/* C1 Cell Block */
$C1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='C1'");
...
/* LE1 Cell Block */
$LE1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='LE1'");
...
/* LE2 Cell Block */
$LE2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='LE2'");
...
/* RG2 Cell Block */
$RG2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='RG2'");
...
/* RG1 Cell Block */
$RG1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='RG1'");
...
/* DT1 Cell Block */
$DT1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='DT1'");
...
/* DT2 Cell Block */
$DT2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='DT2'");
...
/* RT2 Cell Block */
$RT2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='RT2'");
...
/* RT1 Cell Block */
$RT1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='RT1'");
...
/* RE1 Cell Block */
$RE1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='RE1'");
...
/* RE2 Cell Block */
$RE2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='RE2'");
...
/* WR3 Cell Block */
$WR3result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='WR3'");
...
/* MLB2 Cell Block */
$MLB2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='MLB2'");
...
/* WR2 Cell Block */
$WR2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='WR2'");
...
/* ROLB1 Cell Block */
$ROLB1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='ROLB1'");
...
/* ROLB2 Cell Block */
$ROLB2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='ROLB2'");
...
/* TE2 Cell Block */
$TE2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='TE2'");
...
/* TE1 Cell Block */
$TE1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='TE1'");
...
/* CB3 Cell Block */
$CB3result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='CB3'");
...
/* QB2 Cell Block */
$QB2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='QB2'");
...
/* QB1 Cell Block */
$QB1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='QB1'");
...
/* CB2 Cell Block */
$CB2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='CB2'");
...
/* FB1 Cell Block */
$FB1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='FB1'");
...
/* FS1 Cell Block */
$FS1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='FS1'");
...
/* FS2 Cell Block */
$FS2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='FS2'");
...
/* HB3 Cell Block */
$HB3result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='HB3'");
...
/* HB2 Cell Block */
$HB2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='HB2'");
...
/* HB1 Cell Block */
$HB1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='HB1'");
...
/* SS1 Cell Block */
$SS1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='SS1'");
...
/* SS2 Cell Block */
$SS2result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='SS2'");
...
/* * ** Special Teams Table *** */
echo '<a href="#depth"></a>';
echo '<table  class="table table-hover" id="ATL_1_ST" style="text-align: center; font-size: small">';
echo '<tr>';
...
/* K1 Cell Block */
$K1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='K1'");
...
/* P1 Cell Block */
$P1result = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='P1'");
...
/* KR Cell Block */
$KRresult = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='KR'");
...
/* PR Cell Block */
$PRresult = mysql_query("SELECT * FROM `gm_madden08-atl_1_roster` where Position='PR'");
