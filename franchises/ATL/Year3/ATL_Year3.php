        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12" style="text-align: center">
                    <header><h1>ATL - Year 3</h1></header>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <?php include ('ATL_Year3_PreSeason_Table.php'); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <?php include ('ATL_Year3_Roster_Table.php'); ?>
                </div>
            </div>
            <?php
            ...
            if ($_SESSION['Admin'] == true) {
                echo '<div class="row">';
                include ('_Forms/ATL_Year3_RosterForms.php');
                echo '</div>';
            }
            ?>
            <div class="row">
                <div class="col-lg-12">
                    <br><br>
                    <?php include ('ATL_Year3_Reg_Table.php'); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <?php include ('ATL_Year3_Team_Table.php'); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <br><br>
                    <?php include ('ATL_Year3_Stats_Table.php'); ?>
                </div>
            </div>
            <?php
            ...
            if ($_SESSION['Admin'] == true) {
                echo '<div class="row">';
                include ('_Forms/ATL_Year3_StatsForms.php');
                echo '</div>';
            }
            ?>
            <div class="row">
                <div class="col-lg-12">
                    <br><br>
                    <?php include ('ATL_Year3_Coach_Table.php'); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <br><br>
                    <?php include ('ATL_Year3_Offseason_Table.php'); ?>
                </div>
            </div>
            <?php
            /* | IF USER IS LOGGED IN - Display Stat Forms | */
            if ($_SESSION['Admin'] == true) {
                echo '<div class="row">';
                include ('_Forms/ATL_Year3_OffseasonForms.php');
                echo '</div>';
            }
            ?>
